...
lieffect();
shophelp="<li><b>Welcome to the Online Medical Booking Store.<b/>"
shophelp+="<li>Here we pride ourselves in delivering medicines with prime commitment and with an honest, open and trustworthy approach."
shophelp+="<li>We desire to achieve customer fulfillment and satisfaction through their pleasant experience. "
shophelp+="<li>Our motto is to serve and satisfy our customers to the utmost by providing right medical aid when they need it most."
nOpac = 50
nPlus = 2
nMin = 1
speed = 30
...
timer2 = null;
var apl = new Array();
categories=["Ayurvedic","Baby Care","Body Care","Eye Care","Hair&Skin Care","Health Care","Nutrition","Over the Counter(OTC)"];
...
document.writeln('<div class="menuitems" url="signup.htm">New User</div>');
