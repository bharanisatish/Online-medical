...
<table width=600 align=center><form method=get action="login.jsp">
<TR><TD colspan=3 nowrap id=expire></td></tr>
<tr><Td align=right>User-Id:</td><Td><input name=userid><td rowspan=4><img src="addcart.jpg" width=300 height=130 border=0>
<tr><Td align=right>Password:</td><Td><input name=pass type=password></td></tR>
<tr><td colspan=2 align=center><input class=check type=checkbox name=admin value=admin>Login As an Administrator</td></tr>
<tr><td colspan=2 align=center><button type=submit accesskey="L"><u>L</u>ogin</button>&nbsp;&nbsp;
<button type=reset accesskey="R"><u>R</u>efresh</button></td></tr>
<tr><td colspan=2 align=center><a href="forgot.jsp">Forgot Password&nbsp;?</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="change.jsp">Change Password</a></td></tr>
...
<script>if(location.search.indexOf("invalid")!=-1) document.getElementById('expire').innerHTML="<font color=maroon>Invalid User Name and Password&nbsp;&nbsp;[&nbsp;or&nbsp;]&nbsp;&nbsp;Your Login Session May be Expired. Please Relogin</font>";</script>
</body></html>
